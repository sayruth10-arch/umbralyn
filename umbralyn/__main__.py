...
from .history import save_scan, latest_scans_for_target, compare_scans
from .history import list_scans, load_scan_json, save_scan_json
...
def add_scan_common_args(parser: argparse.ArgumentParser) -> None:
    parser.add_argument("target", help="Cible à scanner : IP, plage CIDR ou nom d'hôte")
